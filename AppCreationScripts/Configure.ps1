...
#> 
   ...
   Write-Host "Creating the AAD application (active-directory-dotnet-deviceprofile)"
   $clientAadApplication = New-AzureADApplication -DisplayName "active-directory-dotnet-deviceprofile" `
   ...
   Write-Host "Done creating the client application (active-directory-dotnet-deviceprofile)"
   ...
   $configFile = $pwd.Path + "\..\device-code-flow-console\appsettings.json"
